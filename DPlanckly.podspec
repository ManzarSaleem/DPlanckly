...
Pod::Spec.new do |s|
  s.name             = 'DPlanckly'
  s.version          = '0.1.0'
  s.summary          = 'A short description of DPlanckly.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/ManzarSaleem/DPlanckly'
  ...
  s.source_files = 'DPlanckly/Classes/**/*'
  
  # s.resource_bundles = {
  #   'DPlanckly' => ['DPlanckly/Assets/*.png']
  # }
